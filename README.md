...
### System Architecture
This picture show how the sim of the BlueROV2 is structured in relation to its real counterpart. The purpose have been to mimic the real one in terms of control flow and dynamics. ...
