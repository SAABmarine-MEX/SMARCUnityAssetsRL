...
namespace DefaultNamespace.BlueROV2.ROS.Publishers.TF
{
    public class MapToBaselink_Pub : MonoBehaviour
    {
        ...
        void FixedUpdate()
        {
            ...
            // TODO: use the gameboject frames for more dynamic code
            ...
            TransformStampedMsg tfStamped = new TransformStampedMsg
            {
                ...
                child_frame_id = "bluerov_saab/base_link_gt", // TODO: make robot name dynamic
            ...
            // mocap to tank_base
            Vector3 relPos = tank_base_gt.InverseTransformPoint(mocap_gt.position);
            Vector3<NED> relPosNed = relPos.To<NED>();
            //Quaternion relRot = Quaternion.Inverse(tank_base_gt.rotation) * tank_base_gt.rotation; 
            Quaternion relRot = tank_base_gt.rotation * Quaternion.Euler(0f, 0f, -180f);
